/* Small platform registry shared by the page observer and isolated UI. */
(function (root) {
  "use strict";
  ...
  function detectPlatform(value) {
    ...
    for (const definition of Object.values(DEFINITIONS)) {
      if (definition.hosts.some((host) => hostname === host || hostname.endsWith(`.${host}`))) return definition.id;
    }
    return "unsupported";
  }
