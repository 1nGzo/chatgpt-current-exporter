/* ChatGPT adapter boundary. Existing mapping/current_node code remains in converter.js. */
(function (root) {
  "use strict";
  ...
  function hasMessageList(value) {
    return Boolean(
      value && typeof value === "object" && !Array.isArray(value) && Array.isArray(value.messages) && value.messages.length > 0 &&
      value.current_node !== undefined && value.current_node !== null && value.current_node !== "" && (value.conversation_id || value.id)
    );
  }
